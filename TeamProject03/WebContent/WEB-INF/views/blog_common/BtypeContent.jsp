	...
	<div class="viewcon">
		<div class="total_content">
			<div class="priv_content">
				<p><a href="BbbsDetail.do">
						<strong style="color:#20A524; font-size:15px;">2016년 09월 07일 오전 12시 36분에 저장한 글 입니다.</strong>
					</a> &nbsp;&nbsp;&nbsp;&nbsp;| 신촌
				 </p>
				<p class="view2">
					2016.09.07.&nbsp;&nbsp;&nbsp;12:36&nbsp;&nbsp;&nbsp;
			...
			<div class="foot_content">
				...
				<div class="write_reple">
					...
					<a href="#none" class="sym_pic"><i class="fa fa-heart-o" aria-hidden="true" style="color:red; font-size:11px;"></i>1</a>
				</div>
				<div class="f_right">
					<a href="bbsupdate.do">수정</a>
					<span>&nbsp;|&nbsp;</span>
		...
		<div class="total_content">
			<div class="priv_content">
				<p><a href="BbbsDetail.do">
						<strong style="color:#20A524; font-size:15px;">2016년 09월 06일 오전 10시 09분에 저장한 글 입니다.</strong>
					</a> &nbsp;&nbsp;&nbsp;&nbsp;| java </p>
				<p class="view2">
					2016.09.06.&nbsp;&nbsp;&nbsp;10:09&nbsp;&nbsp;&nbsp;
					<a href="bbsupdate.do">수정</a>
		...
		<div class="total_content">
			<div class="priv_content">
				<p><a href="PbbsDetail.do">
						<strong style="color:#20A524; font-size:15px;">앨범형 세부페이지로 갈거지롱</strong>
					</a> &nbsp;&nbsp;&nbsp;&nbsp;| 전체보기니까 여기도 사진 뜬다
				 </p>
				<p class="view2">
					2016.09.05.&nbsp;&nbsp;&nbsp;11:59&nbsp;&nbsp;&nbsp;
